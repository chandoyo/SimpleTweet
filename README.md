...
- It was a bit challenging to implement the character counter
...
- Difficulty using api keys and api url from Twitter Developer website. (Caused app to crash / not show tweets)
